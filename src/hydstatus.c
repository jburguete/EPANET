...
static StatusType prvstatus (Project *, int, StatusType, double, double,
                             double);
static StatusType psvstatus (Project *, int, StatusType, double, double,
                             double);
...
StatusType
cvstatus (Project * pr, StatusType s, double dh, double q)
/*
**--------------------------------------------------
...
StatusType
pumpstatus (Project * pr, int k, double dh)
/*
**--------------------------------------------------
**  Input:   k  = link index
...
StatusType
prvstatus (Project * pr, int k, StatusType s, double hset, double h1, double h2)
/*
**-----------------------------------------------------------
**  Input:   k    = link index
**           s    = current status
...
StatusType
psvstatus (Project * pr, int k, StatusType s, double hset, double h1, double h2)
/*
**-----------------------------------------------------------
**  Input:   k    = link index
**           s    = current status
...
StatusType
fcvstatus (Project * pr, int k, StatusType s, double h1, double h2)
/*
**-----------------------------------------------------------
**  Input:   k    = link index
**           s    = current status
...
void
tankstatus (Project * pr, int k, int n1, int n2)
/*
**----------------------------------------------------------------
**  Input:   k  = link index
