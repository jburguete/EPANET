...
int
copyreport (Project * pr, char *filename)
/*
**------------------------------------------------------
...
void
writehydstat (Project * pr, int iter, double relerr)
/*
**--------------------------------------------------------------
...
void
writenodetable (Project * pr, Pfloat * x)
/*
**---------------------------------------------------------------
...
void
writelinktable (Project * pr, Pfloat * x)
/*
**---------------------------------------------------------------
...
void
writeheader (Project * pr, int type, int contin)
/*
**--------------------------------------------------------------
...
void
writerelerr (Project * pr, int iter, double relerr)
/*
**-----------------------------------------------------------------
...
void
writestatchange (Project * pr, int k, char s1, char s2)
/*
**--------------------------------------------------------------
**   Input:   k  = link index
**            s1 = old link status
...
void
writecontrolaction (Project * pr, int k, int i)
/*
----------------------------------------------------------------
**   Input:   k  = link index
**            i  = control index
...
void
writeruleaction (Project * pr, int k, char *ruleID)
/*
**--------------------------------------------------------------
**   Input:   k  = link index
**            *ruleID  = rule ID
...
int
writehydwarn (Project * pr, int iter, double relerr)
/*
**--------------------------------------------------------------
**   Input:   iter = # iterations to find hydraulic solution
...
void
writehyderr (Project * pr, int errnode)
/*
**-----------------------------------------------------------
**   Input:   none
**   Output:  none
...
void
marknodes (Project * pr, int m, int *nodelist, char *marked)
/*
**----------------------------------------------------------------
...
void
getclosedlink (Project * pr, int i, char *marked)
/*
**----------------------------------------------------------------
...
void
writelimits (Project * pr, int j1, int j2)
/*
**--------------------------------------------------------------
...
int
checklimits (Report * rpt, double *y, int j1, int j2)
/*
**--------------------------------------------------------------
...
char *
clocktime (char *atime, long seconds)
/*
**--------------------------------------------------------------
