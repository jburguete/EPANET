...
*/
{
  ...
  if (pr->network.Nnodes < 2)
    errcode = 223;
  else if (pr->network.Ntanks == 0)
    errcode = 224;
...
void
inithyd (Project * pr, int initflag)
/*
**--------------------------------------------------------------
...
void
initlinkflow (Project * pr, int i, char s, double k)
/*
**--------------------------------------------------------------------
**  Input:   i = link index
**           s = link status
...
void
setlinkstatus (Project * pr, int index, char value, StatusType * s, double *k)
/*----------------------------------------------------------------
...
void
setlinksetting (Project * pr, int index, double value, StatusType * s,
                double *k)
/*----------------------------------------------------------------
**  Input:   index  = link index
...
int
tanktimestep (Project * pr, long *tstep)
/*
**-----------------------------------------------------------------
...
void
controltimestep (Project * pr, long *tstep)
/*
**------------------------------------------------------------------
**  Input:   *tstep = current time step
**  Output:  *tstep = modified current time step
...
void
ruletimestep (Project * pr, long *tstep)
/*
**--------------------------------------------------------------
...
void
addenergy (Project * pr, long hstep)
/*
**-------------------------------------------------------------
...
void
getenergy (Project * pr, int k, double *kw, double *eff)
/*
**----------------------------------------------------------------
**  Input:   k    = link index
...
void
tanklevels (Project * pr, long tstep)
/*
**----------------------------------------------------------------
**  Input:   tstep = current time step
**  Output:  none
...
double
tankvolume (Project * pr, int i, double h)
/*
**--------------------------------------------------------------------
**  Input:   i = tank index
...
double
tankgrade (Project * pr, int i, double v)
/*
**-------------------------------------------------------------------
**  Input:   i = tank index
**           v = volume in tank
...
void
resetpumpflow (Project * pr, int i)
/*
**-------------------------------------------------------------------
**  Input:   i = link index
**  Output:  none
