...
void
addrule (Parser * parser, char *tok)
//--------------------------------------------------------------
...
void
deleterule (Project * pr, int index)
//-----------------------------------------------------------
...
void
adjustrules (Project * pr, int objtype, int index)
//-----------------------------------------------------------
...
Spremise *
getpremise (Spremise * premises, int i)
//----------------------------------------------------------
...
Saction *
getaction (Saction * actions, int i)
//----------------------------------------------------------
...
int
writerule (Project * pr, FILE * f, int ruleIndex)
//-----------------------------------------------------------------------------
...
void
writepremise (Spremise * p, FILE * f, Network * net)
//-----------------------------------------------------------------------------
...
void
writeaction (Saction * a, FILE * f, Network * net)
//-----------------------------------------------------------------------------
...
void
getobjtxt (int objtype, int subtype, char *objtxt)
//-----------------------------------------------------------------------------
...
void
gettimetxt (double secs, char *timetxt)
//-----------------------------------------------------------------------------
